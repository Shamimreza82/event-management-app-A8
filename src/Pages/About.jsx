...
import bg1 from '../assets/Audiovisual and Technology Support.jpg'
...
const About = () => {
  ...
  return (
    <div className="max-w-7xl m-auto">
        <Helmet>
            <title>Tech Unite Events | About Us</title>
         </Helmet>
          ...
          <div className="-mx-4 flex flex-wrap items-center justify-between">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12" >
              <div className="mt-10 lg:mt-0">
                <span className="text-[#91c733] mb-2 block text-lg font-semibold">
                  Why Choose Us
                </span>
                ...
                <strong>Tech-Centric Expertise:</strong> We are deeply rooted in the tech industry. Our team comprises seasoned professionals who intimately understand the ever-evolving tech landscape, allowing us to design and manage events that resonate with tech enthusiasts and industry leaders alike.
                <br />
                <strong>Innovation Catalysts:</strong> We pride ourselves on being at the forefront of tech innovation. We infuse your events with the latest technological trends and ideas, ensuring that your attendees are engaged, informed, and inspired.
                </p>
