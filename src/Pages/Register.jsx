...
const Register = () => {
    ...
    return (
      ...
      <div className="flex lg:w-[25%] md:w-[50%] flex-col rounded-xl bg-white bg-clip-border text-gray-700 border mx-auto">
        ...
        <div className="flex justify-center text-xl font-bold mt-5">Register</div>
