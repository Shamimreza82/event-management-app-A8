          ...
          <form
            ...
            <label className="block">
              ...
              <input
                ...
                className="block w-full rounded-md shadow-sm py-2 pl-2 focus:ring focus:ri focus:ri "
              />
            </label>
            <label className="block">
              ...
              <input
                ...
                className="block w-full rounded-md shadow-sm focus:ring py-2 pl-2 focus:ri focus:ri "
              />
            </label>
            <label className="block">
