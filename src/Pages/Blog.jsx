...
const Blog = () => {
	...
	<div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12 rounded-md">
		...
		<div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 text-black ">
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-[#91c733] rounded-lg">
				<img role="presentation" className=" object-cover w-full rounded h-44 dark:bg-gray-500 hover:scale-105 hover:duration-300" src={bg2} />
			...
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-[#91c733] rounded-lg">
				<img role="presentation" className="object-cover w-full rounded h-44 dark:bg-gray-500 hover:scale-105 hover:duration-300" src={bg3} />
				<div className="p-6 space-y-2">
			...
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-[#91c733] rounded-lg">
				<img role="presentation" className="object-cover w-full rounded h-44 dark:bg-gray-500 hover:scale-105 hover:duration-300" src={bg4}/>
				<div className="p-6 space-y-2">
		...
		<div className="flex justify-center">
			<button type="button" className="px-6 py-3 text-sm rounded-md hover:underline bg-red-600 dark:text-white">Load more posts...</button>
		</div>
	</div>
</section>
    );
